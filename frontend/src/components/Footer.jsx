...
export default function Footer() {
    ...
    return (
        <footer className="w-full bg-[#1925aa] text-white font-mono text-xs uppercase tracking-wider border-t border-white/20 select-none py-10 px-6">
            <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:items-start md:justify-between space-y-8 md:space-y-0 text-center md:text-left">

                {/* Logo, Copyright and Creator */}
                <div className="flex flex-col items-center md:items-start space-y-3">
                    ...
                    <div className="space-y-1 text-[10px] text-white/80 tracking-wider">
                        ...
                        <p>
                            ...
                            <a
                                ...
                                className="underline hover:text-white transition-colors capitalize"
                            >
                                JACOB LEWIS-SHORES
                            </a>
                        </p>
                ...
                <div className="flex flex-col items-center md:items-start space-y-2">
                    ...
                    <nav className="flex flex-col items-center md:items-start space-y-1.5 text-[10px] text-white/80">
                        {navRoutes.map((route) => (
                            <a
                                key={route.label}
                                href={route.href}
                ...
                <div className="flex flex-col items-center md:items-end space-y-4">
                    ...
                    {/* Email */}
                    <p className="text-[10px] text-white/80 tracking-wider text-center md:text-right">
                        <a
