                        ...
                        <div className="lg:col-span-6 flex flex-col min-h-0">
                            <Card padding="p-3 sm:p-5" className="bg-white text-[#1925aa] border border-[#1925aa] flex flex-col justify-between h-full">
                                                ...
                                                {validSpecs.map(([key, val], idx) => {
                                                    ...
                                                    return (
                                                        ...
                                                        >
                                                            ...
                                                            <span className="font-bold sm:text-right break-words">{val}</span>
                                                        </div>
                                                    );
                                                })}
                                            </div>
                                ...
                                <div className="pt-3 space-y-1.5 shrink-0">
                                    ...
                                    <Link
                                        to="/products"
                                        className="block w-full text-center bg-transparent text-[#1925aa] font-mono text-[11px] sm:text-xs font-bold py-0.5 uppercase tracking-wider hover:underline"
                                    >
                                        RETURN TO PRODUCTS
                                    </Link>
                                </div>
