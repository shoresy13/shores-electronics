                    ...
                    <div className="lg:col-span-7 flex flex-col justify-between space-y-8">
                        <div>
                            ...
                            <p className="text-sm md:text-base uppercase tracking-wide text-[#1925aa]/90 leading-relaxed">
                                HI, I'M JACOB, A THIRD-YEAR CYBER SECURITY STUDENT AT NEWCASTLE UNIVERSITY. IF YOU'RE LOOKING FOR A NEW PC OR WANT TO UPGRADE YOUR CURRENT RIG, I BUILD, OPTIMISE AND REPAIR CUSTOM DESKTOP SETUPS TAILORED TO YOUR EXACT BUDGET AND NEEDS. WHETHER IT'S A HIGH-PERFORMANCE GAMING RIG, A QUIET WORKSTATION OR A BUDGET FRIENDLY DESKTOP FOR EVERYDAY USE, I'LL SOURCE THE BEST PARTS, ASSEMBLE IT PROFESSIONALLY AND ENSURE IT RUNS SMOOTHLY RIGHT OUT OF THE BOX. DROP ME A MESSAGE TO GET A CUSTOM QUOTE, OR EXPLORE MY PREBUILT SYSTEMS!
                            </p>
                        </div>
